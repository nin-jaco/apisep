...
using System.Linq;
using ApiSep.ErrorLogger.Models.Repository.Entities;
using ApiSep.ErrorLogger.Models.Repository.Interfaces;

namespace ApiSep.ErrorLogger.Models.Repository
{
    /// <summary>
    ...
    {
        public ApiSepErrorEntities Context { get; } = null;
        ...
        {
            Context = new ApiSepErrorEntities();
        }
        ...
        public ElmahRepository(ApiSepErrorEntities context)
        {
            Context = context;
        }
        ...
        {
            IQueryable<LogEvent> list = (from a in Context.ELMAH_Error
        ...
        public LogEvent GetById(string id)
        {
            ...
            LogEvent logEvent = (from b in Context.ELMAH_Error
