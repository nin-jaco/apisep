...
namespace ApiSep.ErrorLogger.Models.Repository.Interfaces
{
    /// <summary>
    ...
    public interface ILogReportingFacade
    {
        ...
        /// <param name="logLevel">The level of the log messages</param>
        /// <returns>A filtered list of log events</returns>
        IQueryable<LogEvent> GetByDateRangeAndType(DateTime start, DateTime end, string logProviderName, string logLevel);
