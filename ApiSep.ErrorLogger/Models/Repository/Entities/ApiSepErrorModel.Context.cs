...
namespace ApiSep.ErrorLogger.Models.Repository.Entities
{
    using System;
    ...
    public partial class ApiSepErrorEntities : DbContext
    {
        public ApiSepErrorEntities()
            : base("name=ApiSepErrorEntities")
        {
        }
