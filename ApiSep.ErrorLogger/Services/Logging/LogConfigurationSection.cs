...
namespace ApiSep.ErrorLogger.Services.Logging
{
    // Use the following web.config file.
    // <?xml version="1.0" encoding="utf-8" ?>
    // <configuration>
    //    <configSections>
    //        <section name="logConfiguration" type="MotovateOnTheMove.ErrorHandler.Services.Logging.LogConfigurationSection" />
    //    </configSections>
    //    <logConfiguration>
    //        <logProviders>
    //            <clear />
    ...
    public class LogProviderConfigElement : ConfigurationElement
    {
        ...
        [ConfigurationProperty("type", DefaultValue = "MotovateOnTheMove.ErrorHandler.Models.Repository.NLogRepository", IsRequired = true)]
        public string Type
        {
            get
            {
